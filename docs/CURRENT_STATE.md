...
- 当前提交：`a0869358c680`
- 最近提交：Merge pull request #375 from heydarey/dev_dailyIteration
- `origin/dev`：`a0869358c680`
...
?? test/reports/release-cadence-governance-20260917.md
```
...
{
  "latest": {
    "timestamp": "2026-09-17T10:44:09.560Z",
    "usedPercent": 67,
    "remainingPercent": 33,
    "resetsAt": 1789805405,
    "windowMinutes": 10080
