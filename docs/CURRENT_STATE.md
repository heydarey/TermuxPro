...
- 当前提交：`6df270c893e4`
- 最近提交：Merge pull request #302 from heydarey/dev_dailyIteration
- `origin/dev`：`6df270c893e4`
...
?? test/reports/custom-command-codex-template-20260910.md
```
...
{
  "latest": {
    "timestamp": "2026-09-10T06:46:54.795Z",
    "usedPercent": 27,
    "remainingPercent": 73,
    "resetsAt": 1789435930,
    "windowMinutes": 10080
