...
- 当前提交：`ac4ff481b940`
- 最近提交：Merge pull request #299 from heydarey/dev_dailyIteration
- `origin/dev`：`ac4ff481b940`
...
?? test/reports/git-workbench-entry-naming-20260910.md
```
...
{
  "latest": {
    "timestamp": "2026-09-10T05:59:06.852Z",
    "usedPercent": 26,
    "remainingPercent": 74,
    "resetsAt": 1789435930,
    "windowMinutes": 10080
