...
- 当前提交：`077d987181a4`
- 最近提交：Merge pull request #304 from heydarey/dev_dailyIteration
- `origin/dev`：`077d987181a4`
...
?? test/reports/custom-command-template-list-20260910.md
```
...
{
  "latest": {
    "timestamp": "2026-09-10T07:27:48.206Z",
    "usedPercent": 27,
    "remainingPercent": 73,
    "resetsAt": 1789435931,
    "windowMinutes": 10080
